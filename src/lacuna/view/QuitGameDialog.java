...
public final class QuitGameDialog extends JDialog {
    ...
    private QuitGameDialog(JFrame owner) {
    ...
    public static boolean confirm(JFrame owner) {
        QuitGameDialog dialog = new QuitGameDialog(owner);
    ...
    private JComponent createContent() {
        ...
        JLabel title = label("Quitter la partie ?", 26, Color.WHITE);
        title.setAlignmentX(Component.CENTER_ALIGNMENT);
        JLabel message = label("La partie en cours sera fermee.", 16, new Color(215, 213, 222));
        ...
        JButton quit = new DialogButton("Quitter", true);
        quit.addActionListener((ActionEvent e) -> close(true));
    ...
    private static final class DialogButton extends JButton {
        ...
        DialogButton(String text, boolean destructive) {
            super(text);
        ...
        protected void paintComponent(Graphics g) {
            Graphics2D g2 = (Graphics2D) g.create();
            GameAssets.prepare(g2);
            Color start = destructive ? new Color(198, 56, 68) : new Color(61, 60, 70);
            Color end = destructive ? new Color(234, 73, 83) : new Color(80, 79, 90);
